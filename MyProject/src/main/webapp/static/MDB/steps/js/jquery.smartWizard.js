...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn bg-green sw-btn-next ').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn bg-green sw-btn-prev').attr('type', 'button') : null;
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    toolbarTop = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-top justify-content' + this.toolbarButtonPosition);
                    toolbarTop.append(btnGroup);
                    if (this.toolbarButtonPosition === 'start') {
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-' + this.toolbarButtonPosition);
        ...
        _setEvents: function () {
            ...
            $('.sw-btn-next', this.main).on("click", function (e) {
                e.preventDefault();
                var validado = false;
                $(".tab-pane:visible input").each(function () {
