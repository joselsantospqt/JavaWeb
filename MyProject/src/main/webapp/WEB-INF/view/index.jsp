...
<body>
			...
			<div
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown ml-4 mb-0"><a
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<a class="dropdown-item waves-effect waves-light"
									href="../homepage/v-1.html">V1</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-2.html">V2</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-3.html">V3</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-4.html">V4</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-5.html">V5</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-6.html">V6</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../homepage/v-7.html">V7</a>
							</div></li>
						<li class="nav-item dropdown ml-4  mb-0"><a
							class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold"
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<a class="dropdown-item waves-effect waves-light"
									href="../postpage/v-1.html">V1</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../postpage/v-2.html">V2</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../postpage/v-3.html">V3</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../postpage/v-4.html">V4</a>
							</div></li>
						<li class="nav-item dropdown ml-4  mb-0"><a href="#"
							class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold"
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<a class="dropdown-item waves-effect waves-light"
									href="../author page/v-1.html">V1</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../author page/v-2.html">V2</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../author page/v-3.html">V3</a>
							</div></li>
						<li class="nav-item ml-4 mb-0"><a
							class="nav-link waves-effect waves-light dark-grey-text font-weight-bold"
							href="#">CONTACT <span class="sr-only">(current)</span>
						</a></li>
	...
	<section>
		<div class="container-fluid white">
			...
			<div class="container">
				...
				<!--Section: Blog v.3-->
				<section
					class="section extra-margins mt-5 py-5 text-center text-lg-left">
					...
					<div class="row my-xl-5 py-xl-4">
						...
						<div class="col-sm-12 col-md-5 col-xl-5 mb-4">
							...
							<div class="view overlay">
								<img src="https://mdbootstrap.com/img/Photos/Others/model3.jpg"
						...
						<div class="col-sm-12 col-md-6 col-xl-6">
							...
							<p class="gold-text mb-4 text-uppercase font-weight-bold">SOME
								FACTS ABOUT ME</p>
							<hr>

							<p class="dark-grey-text mt-4 text-justify">Nemo enim ipsam
							...
							<p class="dark-grey-text text-justify">Nemo enim ipsam
								voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed
								quia consequuntur magni dolores eos qui ratione voluptatem sequi
								nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor
								sit amet, consectetur, adipisci velit, sed quia non numquam eius
	...
	<footer
		class="page-footer rgba-stylish-strong text-center text-md-left mt-4 pt-4">
					...
					<div class="social-section text-center text-md-left">
						<ul class="list-unstyled list-inline">
							<li class="list-inline-item mx-0"><a
								class="btn-floating btn-sm rgba-white-slight mr-xl-4 waves-effect waves-light">
